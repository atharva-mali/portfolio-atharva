...
const experiences = [
  {
    ...
    subtitle: "Lexicon Networks India Pvt. Ltd., Pune",
    dateRange: "July 2025 - Present",
    description:
      "Contributing to the design, development, and optimization of integration workflows and enterprise applications using Jitterbit, Shopify Admin APIs, NetSuite APIs, GraphQL API, REST/SOAP API, and modern web technologies, focusing on Shopify–NetSuite integrations.",
    logo: lexiconLogo, // Add the logo path here
  },
  {
    title: "Software Developer Trainee",
    subtitle: "Lexicon Networks India Pvt. Ltd.",
    dateRange: "Feb 2025 - July 2025",
    description:
      " Gaining hands-on experience in Integration Development using advanced tools like Jitterbit and Celigo",
    logo: lexiconLogo, // Add the logo path here
  },
  {
    ...
    description:
      "This role allow me to enhance my skills in website development, front-end and back-end programming, security analysis, and database management.",
...
const education = [
  {
    ...
    dateRange: "2023 - 2025",
    description:
      "Student Coordinator for Sinhgad Spring Fest - TechDrill 2024 for the event Code Battle at Sinhgad Institute of Management, Pune.",
  ...
  },
  {
    ...
    dateRange: "2020 - 2023",
    description:
      "Member of DSAC Club, ACSES (Association of Computer Science & Engineering Students) and CSI (Computer Society of India)",
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div
          ref={timelineRef}
          className="relative wrap overflow-hidden p-4 md:p-10 h-full mt-10"
        >
          <div
            ref={timelineLineRef}
